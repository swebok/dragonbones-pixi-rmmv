...
(function(superClass){
    ...
    __extends(PixiFactory, superClass, {
        _generateArmature:function(){
            var armature = new Armature(new PIXI.DisplayObjectContainer);
            return armature;
        },
        ...
        _generateDisplay:function(textureAtlas, fullName, pivotX, pivotY){
			...
			var textureFullPath = textureAtlas.texture.baseTexture.imageUrl;
			...
			var texturePath = textureFullPath.substr(2).split(".")[0];
			var sprite = new Sprite(ImageManager.loadBitmap('', texturePath, 0, true));
			sprite.setFrame(region.x, region.y, region.width, region.height);
